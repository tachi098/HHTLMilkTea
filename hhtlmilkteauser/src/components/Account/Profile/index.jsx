...
import { Avatar, Button, Grid, makeStyles, TextField, FormHelperText, Backdrop, CircularProgress } from "@material-ui/core";
                    ...
                    <Grid container className={classes.content}>
                            ...
                            <Grid item xs={12} sm={12}>
                                <TextField
                                    ...
                                    inputRef={register({
                                        ...
                                        pattern: { value: /^[a-zA-Z_ÀÁÂÃÈÉÊẾÌÍÒÓÔÕÙÚĂĐĨŨƠàáâãèéêìíòóôõùúăđĩũơƯĂẠẢẤẦẨẪẬẮẰẲẴẶẸẺẼỀỀỂưăạảấầẩẫậắằẳẵặẹẻẽềềểếỄỆỈỊỌỎỐỒỔỖỘỚỜỞỠỢỤỦỨỪễệỉịọỏốồổỗộớờởỡợụủứừỬỮỰỲỴÝỶỸửữựỳỵỷỹ\s]+$/, message: "Tên không hợp lệ" }
                                    })}
                                />
                                {errors.fullName?.message &&
                                    <FormHelperText style={{ color: 'red' }} id="component-error-text">{errors.fullName?.message}</FormHelperText>
                                }
                            </Grid>
                            <Grid item xs={12}>
                                <TextField
                                ...
                                />
                                {errors.birthday &&
                                    <FormHelperText style={{ color: 'red' }} id="component-error-text">Ngày sinh không được để trống</FormHelperText>
                                }
                            </Grid>
                            <Grid item xs={12}>
                                <TextField
                                ...
                                />
                                {errors.address &&
                                    <FormHelperText style={{ color: 'red' }} id="component-error-text">Địa chỉ không được để trống</FormHelperText>
                                }
                            </Grid>
                            <Grid item xs={12}>
                                <TextField
                                    ...
                                    inputRef={register({ required: "Số điện thoại không được để trống", pattern: { value: /^[0-9]{9,11}$/i, message: "Số điện thoại không hợp lệ" } })}
                                />
                        ...
                        <Grid item md={4} xs={12} sm={12} style={{ paddingLeft: 30, paddingTop: 20 }}>
                            <Grid item xs={12} sm={12} className={classes.upload}>
                                <Avatar alt="avatar" src={img ? img : customer.linkImage} className={classes.large} />
