import { Avatar, Grid, List, ListItem, ListItemIcon, ListItemText, makeStyles, Typography } from "@material-ui/core"
import React from "react"
import { PermIdentityOutlined, AssignmentOutlined, ConfirmationNumberOutlined } from '@material-ui/icons';
            ...
            <Grid container className={classes.container}>
                <Grid item md={2} xs={4} className={classes.navbar}>
                    <div className={classes.navHeader}>
                        ...
                        <div>
                            <Typography className={classes.username}><b>Pham Quang Huy</b></Typography>
                        </div>
                    </div>
                    <List component="nav" aria-label="main mailbox folders">

                        <Link to='/account' style={{ textDecoration: 'none', color: '#203a53' }}>
                            <ListItem button>
                                <ListItemIcon>
                        ...
                        <Link to='/account/history' style={{ textDecoration: 'none', color: '#203a53' }}>
                            <ListItem button>
                                <ListItemIcon>
                        ...
                        <Link to='/account/voucher' style={{ textDecoration: 'none', color: '#203a53' }}>
                            <ListItem button>
                                <ListItemIcon>
