...
const History = () => {
    ...
    const fields = [
        ...
        { name: "payment", lable: "Phương thức thanh toán", dir: "asc" },
    ...
    const handleOnDelete = (id) => {
        // dispatch(OrderStatusUpdate({ id, status: "delete" }));
                                        ...
                                        <TableBody>
                                            {listProcess.map((order) => (
                                                <TableRow key={order.id}>
                                                    ...
                                                    <TableCell>
                                                        {order.payment === 1 ? "Thanh toán khi nhận" : ""}
                                                        {order.payment === 2 ? "Thanh toán bằng thẻ" : ""}
                                                    </TableCell>
