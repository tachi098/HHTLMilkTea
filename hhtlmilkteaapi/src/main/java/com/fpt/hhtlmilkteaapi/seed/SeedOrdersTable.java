...
public class SeedOrdersTable {
    ...
    public static void insertData() {
        ...
        if (count == 0) {
            ...
            //Insert Order 5
            Order order05 = new Order("O0882021035833","Binh Thanh, Ho Chi Minh", "0123456789", 1, 3, "Không thêm đường", 50, user01, 50000);
            //Insert Order 6
            Order order06 = new Order("O0882021035834","Binh Thanh, Ho Chi Minh", "0123456789", 2, 3, "Không thêm đường", 50, user01, 50000);
            //Insert Order 7
            Order order07 = new Order("O0882021035835","Binh Thanh, Ho Chi Minh", "0123456789", 1, 3, "Không thêm đường", 50, user01, 50000);
            //Insert Order 8
            Order order08 = new Order("O0882021035836","Binh Thanh, Ho Chi Minh", "0123456789", 2, 3, "Không thêm đường", 50, user01, 50000);
            //Insert Order 9
            Order order09 = new Order("O0882021035837","Binh Thanh, Ho Chi Minh", "0123456789", 1, 3, "Không thêm đường", 50, user01, 50000);
            //Insert Order 10
            Order order10 = new Order("O0882021035838","Binh Thanh, Ho Chi Minh", "0123456789", 1, 3, "Không thêm đường", 50, user01, 50000);
            // Insert Data
